        ...
        container.innerHTML = publications.map((pub) => `
            <div class="academic-card mb-6 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    ` : ''}
                    ${pub.full_document ? `
                        <a href="${pub.full_document}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 border-2 border-primary text-primary hover:bg-primary hover:text-white rounded-lg transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
